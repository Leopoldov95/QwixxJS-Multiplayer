...
class Player {
  ...
  // generate the color score boxes, fucking piece of shit doesnt work
  /* createListItem(item, rowColor, lockColor) {
    //console.log(rowColor[11]); // this is the freaking answer
    if (rowColor.indexOf(item) === 11) {
      if (rowColor[11] !== 0) {
